...
// import { FontAwesomeIcon } from '@fortawesome/react-native-fontawesome';
// import { faDollarSign, faTrash  } from '@fortawesome/free-solid-svg-icons'; // Icono de colaboración
...
//   }
//   const handleCollaboration = () => {
//     // Aquí puedes navegar a otra pantalla o abrir un modal, etc.
//     Alert.alert("En Desarrollo", "Aun  estamos desarrollando el modulo.");
//   };

//   const handleDelete = () => {
//     // Aquí puedes manejar la lógica para eliminar
 
//     Alert.alert("Elemento eliminado.", "Aun en desarrollo");
//   };
//   return (
//     <View style={styles.container}>
//       <Text style={styles.title}>DATOS DE CONTACTO...</Text>
...
//         <TouchableOpacity style={styles.iconButton} onPress={handleViewComent}>
//           <Icon name="whatsapp" size={40} color="black" />
//         </TouchableOpacity>
